...
flowchart TD
    subgraph INPUTS["Satellite & climate inputs (Google Earth Engine)"]
        ...
        SOIL["OpenLandMap<br/>soil water (250 m)"]
...
| Soil water | `OpenLandMap/SOL/SOL_WATERCONTENT-33KPA_...` | 250 m | WHC for WRSI | — |
...
```
Spatial **WHC** from OpenLandMap field capacity − wilting point, integrated over the crop root zone (`src/soil.py`).
