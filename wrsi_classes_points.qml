...
<qgis version="3.28" styleCategories="Symbology">
  <renderer-v2 type="graduatedSymbol" attr="WRSI" graduatedMethod="GraduatedColor" symbollevels="0" forceraster="0" enableorderby="0">
    <ranges>
      ...
      <symbol type="marker" name="0">
        <layer class="SimpleMarker">
          <Option type="Map">
            ...
            <Option name="outline_color" type="QString" value="60,60,60,255"/>
