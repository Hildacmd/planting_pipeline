...
The water balance is rainfed by construction (`Wb = SW + P`, no irrigation term). Of the 40 products
...
local one, and 31 are unaffected. The one measurable inversion is **Sudan millet Kharif**: across its
